...
import com.dynamsoft.barcode.IntermediateResultCallback;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ErrorCallback errorCallback = new ErrorCallback() {
			...
			public void errorCallback(int frameId, int errorcode, Object userData) {
				if (errorcode != 0) {
					Log.e("Dbr video error: ","Error occured when decode frame " + frameId);
				}

			}
		};
		final TextResultCallback textResultCallback = new TextResultCallback() {
			@Override
			public void textResultCallback(int frameId, TextResult[] textResults, Object userData) {
		...
		final IntermediateResultCallback intermediateResultCallback = new IntermediateResultCallback() {
			@Override
			public void intermediateResultCallback(int frameId, IntermediateResult[] intermediateResults, Object userData) {
